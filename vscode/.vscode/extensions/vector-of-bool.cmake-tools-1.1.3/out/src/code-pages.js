...
const log = logging_1.createLogger('code-pages');
 ...
 */
async function _getWindowsCodePage() {
    const proc = await Promise.resolve().then(() => require('@cmt/proc'));
...
//# sourceMappingURL=code-pages.js.map