...
var Sender = (function () {
    ...
    */
    ...
    Sender.prototype._getACLIdentity = function (callback) {
        ...
        var psProc = child_process.spawn(Sender.POWERSHELL_PATH, ["-Command", "[System.Security.Principal.WindowsIdentity]::GetCurrent().Name"], { windowsHide: true });
        var data = "";
    ...
    Sender.prototype._getACLIdentitySync = function () {
        ...
        // Some very old versions of Node (< 0.11) don't have this
        if (child_process.spawnSync) {
            var psProc = child_process.spawnSync(Sender.POWERSHELL_PATH, ["-Command", "[System.Security.Principal.WindowsIdentity]::GetCurrent().Name"], { windowsHide: true });
            if (psProc.error) {
                throw psProc.error;
            }
